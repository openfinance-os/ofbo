...
// CODE-02 — in-memory store(s) moved to services/bff/memory/trust-framework.ts (demo-profile production
// defaults, not test fixtures). Re-exported so every existing import is unchanged.
export {
  InMemoryTrustFrameworkParticipantStore
} from '../../memory/trust-framework.js'
