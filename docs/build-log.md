...
- M2 (Customer Care, E2) eligible queue now empty. Remaining M2 blocked: BACKOFFICE-25 (ADR 0001 — care-token surface, awaiting human decision). Loop advances to M3 (Reconciliation, E1) — BACKOFFICE-01 next.
